...
def readSignals():
	...
	print robot_state
        ...
        if (robot_state == 0):
            ...
            print "\rReceieved "+str(data)+ " from RAVEN"
...
def sendPackets():
    ...
    seg_index = headers.index('field.seg_label');
