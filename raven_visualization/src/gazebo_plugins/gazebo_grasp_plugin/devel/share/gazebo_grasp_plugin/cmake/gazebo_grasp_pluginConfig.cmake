...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin/devel)
...
if(NOT "/home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin/${idir}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/raven/raven_2/raven_visualization/src/gazebo_plugins/gazebo_grasp_plugin/devel/lib;/opt/ros/indigo/lib)
