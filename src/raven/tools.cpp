...
void tool::set_limits() {
	switch (t_end) {
	case r_grasper:
		rot_max_angle = 330 DEG2RAD; //270 DEG2RAD;
		...
		wrist_max_limit = 70 DEG2RAD; //75 DEG2RAD;
		wrist_min_limit = -70 DEG2RAD; //-75 DEG2RAD;

		grasp1_max_angle = 120 DEG2RAD;
		grasp1_min_angle = -120 DEG2RAD;
		grasp1_max_limit = 105 DEG2RAD; //85 DEG2RAD;
		grasp1_min_limit = -105 DEG2RAD; //-85 DEG2RAD;

		grasp2_max_angle = 120 DEG2RAD;
		grasp2_min_angle = -120 DEG2RAD;
		grasp2_max_limit = 105 DEG2RAD; //85 DEG2RAD;
		grasp2_min_limit = -105 DEG2RAD; //-85 DEG2RAD;
		break;
	...
	case large_needle:
		...
		rot_max_limit = 220 DEG2RAD; //182 DEG2RAD;
		rot_min_limit = -220 DEG2RAD; //-182 DEG2RAD;
		...
		grasp1_max_angle = 115 DEG2RAD; //120 DEG2RAD;
		grasp1_min_angle = -115 DEG2RAD; //-120 DEG2RAD;
		grasp1_max_limit = 85 DEG2RAD;
		grasp1_min_limit = -85 DEG2RAD;

		grasp2_max_angle = 115 DEG2RAD; //120 DEG2RAD;
		grasp2_min_angle = -115 DEG2RAD; //-120 DEG2RAD;
		grasp2_max_limit = 85 DEG2RAD;
		grasp2_min_limit = -85 DEG2RAD;
		break;
	...
	case bipolar_forceps:
		...
		grasp1_max_angle = 140 DEG2RAD; //120 DEG2RAD;
		grasp1_min_angle = -140 DEG2RAD; //-120 DEG2RAD;
		grasp1_max_limit = 85 DEG2RAD;
		grasp1_min_limit = -85 DEG2RAD;

		grasp2_max_angle = 140 DEG2RAD; //120 DEG2RAD;
		grasp2_min_angle = -140 DEG2RAD;//-120 DEG2RAD;
		grasp2_max_limit = 85 DEG2RAD;
		grasp2_min_limit = -85 DEG2RAD;
		break;
	...
	case mopocu_scissor:
		...
		rot_min_angle = -260 DEG2RAD; //might not be correct
		rot_max_limit = 250 DEG2RAD;//182 DEG2RAD;
		rot_min_limit = -250 DEG2RAD;//-182 DEG2RAD;
		...
		grasp2_max_angle = 105 DEG2RAD;//100 DEG2RAD;
		grasp2_min_angle = -105 DEG2RAD;//-100 DEG2RAD;
		grasp2_max_limit = 95 DEG2RAD;//85 DEG2RAD;
		grasp2_min_limit = -95 DEG2RAD;//-85 DEG2RAD;
		break;
	...
	case potts_scissor:
		...
		wrist_max_angle = 85 DEG2RAD;//90 DEG2RAD;
		wrist_min_angle = -85 DEG2RAD;//-90 DEG2RAD;
		wrist_max_limit = 75 DEG2RAD;
		wrist_min_limit = -75 DEG2RAD;

		grasp1_max_angle = 130 DEG2RAD;//120 DEG2RAD;
		grasp1_min_angle = -130 DEG2RAD;//-120 DEG2RAD;
		grasp1_max_limit = 110 DEG2RAD;//90 DEG2RAD;
		grasp1_min_limit = -110 DEG2RAD;//-90 DEG2RAD;

		grasp2_max_angle = 130 DEG2RAD;
		grasp2_min_angle = -130 DEG2RAD;
		grasp2_max_limit = 110 DEG2RAD;//90 DEG2RAD;
		grasp2_min_limit = -110 DEG2RAD;//-90 DEG2RAD;
		break;
