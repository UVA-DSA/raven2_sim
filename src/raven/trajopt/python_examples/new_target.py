...
xyz_target = [5.51073449e-01,  +1.87673551e-01, 4.91061915e-01]
...
#init_joint_target = [-0.545383 1.10678755 -1.011 -1.4685711 2.23966055 -0.49456781 -1.88157859]
print init_joint_target
#init_joint_target = np.asarray(init_joint_target)
#for i in range(len(init_joint_target)):
#	init_joint_target[i] = -1.1
#print init_joint_target
# END ik
...
#    "manip" : "rightarm", # see below for valid values
  ...
  {
    "type" : "collision",
    "name" :"coll", # shorten name so printed table will be prettier
    "params" : {
      "continuous" : True,
...
print "result: {}" .format(result.GetTraj())
